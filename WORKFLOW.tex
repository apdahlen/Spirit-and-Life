...
% Best guess:
%
% Sverdrup is the shepherd who braids his text.
%
% Oftedal grabs you by the belt, breaks you, 
% and then asks whether you will survive the encounter with Jesus.
%
% DO NOT attempt to answer authorship in this book. 
...
% * Structural fidelity – retaining the order, logical flow, and rhetorical shape of the 1871 Danish text as far as English allows.
% * Emotional equivalence – maintaining the moral and rhetorical intensity of the original, even where English requires a different form to convey the same force.
% * Theological precision – rendering key doctrinal terms consistently and without interpretive softening.
%
% No attempt has been made to modernize theology, harmonize with existing English Bible translations, or stylistically embellish the source.
...
\input{Sermon175/Sermon175.tex}\pagebreak
\input{Sermon179/Sermon179.tex}\pagebreak
